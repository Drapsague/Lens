...
predicate isLLMGeneratedSource(DataFlow::Node source) {
    exists(DataFlow::ParameterNode p |
        source = p and (
            (p.getScope().getName() = "hash_password" and p.getParameter().getName() = "password")
            or (p.getScope().getName() = "verify_password" and p.getParameter().getName() = "password")
            or (p.getScope().getName() = "secure_session" and p.getParameter().getName() = "app")
            ...
            or (p.getScope().getName() = "get_user_by_username" and p.getParameter().getName() = "username")
